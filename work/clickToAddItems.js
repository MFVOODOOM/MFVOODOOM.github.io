funtion clearErrors() {
  for (var loopCounter = 0;
      ...
      loopCounter++) {
        if(document.forms["numberFun"].elements[loopCounter].parentElement.class.name.indexOf("has-") !=-1) {
...
function resetForm() {
  ...
  document.getElelemntsById("submitButton").innerText = "Submit";
...
function validateItems() {
    ...
    //return false so the the form doesn't submit and we can see the results
    return false;
  }
adg
